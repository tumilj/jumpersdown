...
<p align="center">
Need a dependable web host?  Try: <a href="http://www.seiretto.co.uk/"><strong>PHP and MySQL UK business hosting</strong></a>
<br><br>
<strong>header.inc</strong></p>

<div align="left" style="border:solid 2px #0000FF; background:#EAEDFC; color:#000000; padding:2px; width:800px; height:300px; overflow:auto;">
  <?php show_source("./inc/header.inc"); ?>
</div>
<p align="center"><br>
</p>
<p align="center"><strong>footer.inc</strong></p>
<div align="left" style="border:solid 2px #0000FF; background:#EAEDFC; color:#000000; padding:2px; width:800px; height:300px; overflow:auto;">
  <?php show_source("./inc/footer.inc"); ?>
</div>
